    ...
    <div className="container about" style={{maxWidth: '800px'}}>
      <div className="row">
        <div className="col-md-8">
          <p> 
            I am a <span>Software Engineer</span> and <span>Information Technology enthusiast</span>. I help business agencies and individuals by creating all types of web applications and softwares. I like experiencing new things as well.
            <br /><br />
