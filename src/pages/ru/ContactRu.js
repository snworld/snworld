          ...
          <div className="col-md-6 text-center">
            ...
            <div className="d-flex justify-content-center contact-icons">
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://www.t.me/nerouxc" style={{background: "transparent"}}>
              ...
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://instagram.com/__snworld" style={{background: "transparent"}}>
              ...
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://api.whatsapp.com/send?phone=996706768788" style={{background: "transparent"}}>
