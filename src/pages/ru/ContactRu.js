...
const ContactRu = () => {
  ...
  const messageSubmit = (e) => {
    ...
    if(messageSent) {
      setTimeout(() => {setMessageSent(messageSent = !messageSent)}, 8000)
    }
    ...
    <>
      ...
      <div className="container contact" style={{maxWidth: "800px"}}>
          ...
          <div className="col-md-6 text-center">
            ...
            <div className="d-flex justify-content-center contact-icons">
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://www.t.me/snworld00" style={{background: "transparent"}}>
              ...
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://instagram.com/_snworld" style={{background: "transparent"}}>
              ...
              <div className="contact-icon">
                <a target="_blank" rel="noreferrer" href="https://api.whatsapp.com/send?phone=996550768788" style={{background: "transparent"}}>
        ...
        <p className={`form-modal text-center ${messageSent === true ? 'd-block active' : 'inactive'}`} >
          Ваше сообщение успешно отправлено. Мы постараемся ответить вам как можно быстрее.
        </p>
      </div>
      <LangLinkRu />
    </>
