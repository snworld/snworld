        ...
        <div className="row">
          <div className="col-md-8">
            <p className="text-justify"> 
              My name is Samir Nurbek. I'm a <span>Software Engineer</span> and <span>Information Technology enthusiast</span>. I help business agencies and individuals by creating all types of web applications and software products. I'm very passionate about traveling and experiencing new things.
              <br /><br />
